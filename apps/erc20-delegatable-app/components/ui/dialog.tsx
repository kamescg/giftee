...
const DialogContentXL = React.forwardRef<
  React.ElementRef<typeof DialogPrimitive.Content>,
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content>
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed z-50 grid w-full scale-100 gap-4 bg-white p-6 opacity-100 animate-in fade-in-90 slide-in-from-bottom-10 sm:max-w-screen-md sm:rounded-lg sm:zoom-in-90 sm:slide-in-from-bottom-0',
        'dark:bg-slate-900',
        className
      )}
      {...props}>
...
DialogContentXL.displayName = DialogPrimitive.Content.displayName
...
export { Dialog, DialogTrigger, DialogContent, DialogContentXL, DialogHeader, DialogFooter, DialogTitle, DialogDescription }
